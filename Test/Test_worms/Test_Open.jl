...
function test_open_config(s::System)
    config = [[Coord([-1.0, -1.0]), Coord([1.0, 1.0])]]
    perm = [1]
...
function main()
    ...
    s = System(potential; dim = 2, M = 100, N = 1, L = 4.0, T = 1, g=1.16, μ = 4.0, C = SectorCounter(1/((4.0)^2*50*100)), worms = true, propint = propint, rₐ = 1.0)
