...
include("/Pimc.jl/examples/tools/logtools.jl")
include("/Pimc.jl/examples/tools/plottools.jl")
include("/Pimc.jl/examples/tools/savetools.jl")
...
function test_swap_config(s::System)
    config = [[Coord([0.0, 0.0]), Coord([0.0, 0.0])]]
    perm = Int64[1]
    worm_config = [[Coord([1.0, 1.0, Int64(20)]), Coord([-1.0, -1.0, Int64(80)])]]
...
function main()
    ...
    SW = NumbOfSlices(50, 1, s.M - 1, 0.4, 0.6)
    for _ in 1:1
        test_swap_config(s)
