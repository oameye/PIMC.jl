...
function test_close_config(s::System)
    config = [[Coord([3.0, 3.0]), Coord([3.0, 3.0])], [Coord([3.0, -3.0]), Coord([3.0, -3.0])]]
    perm = Int64[1,2]
    worm_config = [[Coord([-1.1, -1.1, Int64(1)]), Coord([-1.1, -1.1, Int64(45)])], [Coord([-1.1, -1.1, Int64(55)]), Coord([-1.1, -1.1, Int64(100)])]]
